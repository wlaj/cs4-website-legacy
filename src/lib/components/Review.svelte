...
<section class="bg-neutral-50 dark:bg-neutral-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <figure class="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    <p class="text-xl font-medium text-neutral-900 md:text-2xl dark:text-white">"{blok.headline}"</p>
                </blockquote>
                <figcaption class="flex items-center justify-center mt-6 space-x-3">
                    <div class="flex items-center divide-x-2 divide-neutral-500 dark:divide-neutral-700">
                        ...
                        <div class="pl-3 text-sm font-light text-neutral-500 dark:text-neutral-400">{blok.job}</div>
                    </div>
                </figcaption>
            </figure>
        </div>
